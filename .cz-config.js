module.exports = {
  ...
  scopes: [
    { name: 'nx-bun', description: 'Whole repo' },
    { name: 'docs', description: 'Docs specific' },
    { name: 'nx', description: 'Stencil specific' },
    { name: 'worker-task', description: 'NX Task Worker Runner' },
    { name: 'bun-task', description: 'NX Task Runner in Bun' },
  ],
